                ...
                <div class="tab-pane fade show active profile-edit pt-3" id="profile-edit">
                  ...
                  <form method="POST" action="">
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <input name="kota" type="text" class="form-control" id="Country" value="<?php echo $data['kota'];?>" required>
                      </div>
                    </div>
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <input name="provinsi" type="text" class="form-control" id="Address" value="<?php echo $data['provinsi'];?>" required>
                      </div>
                    </div>
